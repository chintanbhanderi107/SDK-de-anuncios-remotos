...
import com.custom.ads.sdk.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AdsApplication.setMainScreenFrequency(0)
        AdsApplication.setMainScreenBannerFrequency(0)
        AdsApplication.setMainScreen3Frequency(0)
        ...
        initData(object : DataLoadCompleteListener {
            override fun onDataLoaded() {
                ...
                AdsUtils.loadInterstitialAd(this@MainActivity)
                AdsUtils.loadAndShowAppOpenAd(this@MainActivity,
